...
%-------------------------------------------------------------------------------------
\usepackage{amsmath, amssymb, physics, siunitx,nicefrac}
...
\chapter{En-Face Fluorescence Lifetime Imaging Ophthalmoscope}\label{chap:fliodevice}
\subfile{chapters/fliodevice.tex}

\chapter{FLIM Analysis Methods}\label{chap:flimanalysis}
\subfile{chapters/flimanalysis.tex}

\chapter{FLIO - In-Vitro Imaging Demonstrations}\label{chap:invitro}
\subfile{chapters/flioinvitro.tex}


\chapter{FLIO  - Ex-Vivo Imaging Demonstrations}\label{chap:exvivo}
\subfile{chapters/flioexvivo.tex}

\chapter{FLIO - In-Vivo Imaging Demonstrations}\label{chap:invivo}
\subfile{chapters/flioinvivo.tex}


\chapter{Spectrally Resolved Fluorescence Lifetime Imaging}\label{chap:sflim}
\subfile{chapters/sflim.tex}


\chapter{Novel Applications of TCSPC / Material Discrimination}\label{chap:materialdisc}
