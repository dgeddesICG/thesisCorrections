...
\chapter{Construction and Characterisation of an En-Face Fluorescence Lifetime Imaging Ophthalmoscope (+) Done To Be Checked}\label{chap:fliodevice}
\subfile{chapters/sfliodevice.tex}

\chapter{Reconstructing Fluorescence Lifetime Images from a Moving Scene}
...
\chapter{Detection of FAD in \textit{in-vivo} rat retinas (-) Not Even Started}\label{chap:ratfad}
