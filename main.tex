...
%-------------------------------------------------------------------------------------
\usepackage{amsmath, amssymb, physics,nicefrac}
\usepackage{siunitx}
...
\chapter{Introduction - Draft- }\label{chap:intro}
\subfile{chapters/introduction.tex}


\chapter{En-Face Fluorescence Lifetime Imaging Ophthalmoscope - Done To Be Checked}\label{chap:fliodevice}
\subfile{chapters/fliodevice.tex}

% \chapter{FLIM Analysis Methods}\label{chap:flimanalysis}
% \subfile{chapters/flimanalysis.tex}


\chapter{Spectrally Resolved Fluorescence Lifetime Imaging - Done To Be Checked}\label{chap:sflim}
\subfile{chapters/sflim.tex}

\chapter{Detection of FAD in \textit{in-vivo} rat retinas}\label{chap:ratfad}
\subfile{chapters/ratFAD.tex}

\chapter{Novel Applications of TCSPC / Material Discrimination - Draft - Need to add results and conclusions}\label{chap:materialdisc}
...
\subfile{chapters/appendices/Atensoralgebra.tex}


\chapter{Safety Assessment for SFLIO instrument}\label{app:sfliosafety}
\subfile{chapters/appendices/Bsflioassessment.tex}
