...
As outlined in~\cref{sec:motivation} the purpose of this project is to use the principles of fluorescence lifetime imaging and spectral fluorescence imaging to further develop capabilities of chemical sensing in the retina. This was achieved using an off-the-shelf fundus camera modified to enable spectrally-resolved fluorescence lifetime measurements of the retina with a FOV wide enough to span the fovea (\qty{20}{\degree})
