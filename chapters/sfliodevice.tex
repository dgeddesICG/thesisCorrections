...
\end{equation}
The rotation of the edge in the image plane enables the ESF to be sampled with sub-pixel precision due each line profile - through the edge - being displaced by less than a single pixel in the direction perpendicular to the edge.
