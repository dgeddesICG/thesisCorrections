...
\FloatBarrier
\section{Rationale}
Throughout this thesis the technique of TCPSC has been utilised to resolve the temporal decays of excited fluorophores in the retina. However, the ability to correlate the arrival time of single photons - generated from reflections of ultra-short pulses - can also be exploited for time-of-flight based depth mapping for 3D imaging \cite{rapp2021high} where even the flash-based LIDAR sensors in consumer electronics can construct 3D scans of a room with \SI{<1}{\cm} resolution-\cite{teo2023evaluating}. Notably, the temporal resolution of modern TCSPC modules is sufficient to measure the broadening experience by back-scatter or reflected ultra-short pulses of light penetrating tissue~\cite{patterson1989time}. 
\\
In this project this phenomena of temporal broadening was briefly explored for the possibility of discriminating in a scene. Primarily this technique has potential defence applications where an unknown combatant could be identified through an obscurant like a glass window as well as if they are armed using the unique opto-temporal characteristics of a person and a weapon (steel) where ordinarily, infrared imaging systems are incapable of imaging through standard window glass due its inherent low transmission in the infrared spectrum. For retinal imaging this property can be used for removing the influence of corneal reflections and lenticular fluorescence where the these unwanted contamination's would be displaced by $\approx \Delta t = \SI{200}{\ps}$ along the temporal axis in TCPSC measurements.
