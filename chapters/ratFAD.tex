...
\end{equation}
By comparing the T-statistic with a $t$-distribution the $p$-value can be extracted to give a probability of the null-hypothesis.

\begin{table}[t]
    \centering
    \sisetup{table-alignment-mode=format, round-mode=figures}
    \small
    \begin{tabular}{|p{3.2cm}|  S[table-column-width = 1.5cm, round-precision=4]|
                                S[table-column-width = 1.5cm, round-precision=2]|
                                S[table-column-width = 1.5cm, round-precision=4]|
                                S[table-column-width = 1.5cm, round-precision=2]|
                                S[table-column-width = 1.5cm, round-precision=4]|
                                S[table-column-width = 1.5cm, round-precision=2]|
                                S[table-column-width = 1.5cm, round-precision=4]|
...
%              Change in Oxygenation State & Relative change in FAD &  $p$-value\\ 
%         \end{tabular}
%         \caption{tab 1}
%         \label{tab:ttest-070224}
%     \end{subtable}
%     % table 080224
%     \begin{subtable}{0.45\textwidth}
%         \centering
...
%         \end{tabular}
%         \caption{tab 2}
%         \label{tab:ttest-080224}
%     \end{subtable}
%     % table 090224
%     \begin{subtable}{0.45\textwidth}
%         \centering
%         \begin{tabular}{|c|c|c|}[t]
%             Oxygenation State & Relative change in FAD & $p$-value\\
%         \end{tabular}
%         \caption{tab 3}
%         \label{tab:ttest-090224}
%     \end{subtable}
