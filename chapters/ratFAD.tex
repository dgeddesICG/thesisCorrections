...
\begin{itemize}
    \item FAD as a marker for metabolic health in the retina
    \begin{itemize}
        \item FAD is a marker of oxygen metabolisation
        \item Changes in oxygen metabolisation, in principle, can be linked to disease. Disruption in oxygen use in the retina could signify onset of disease
        \item Measuring FAD concentration is difficult - we don't know where in the retina its located (x,y, and z) or how much it is. Contamination due to vasculature, and other fluorescence clutter makes this more challenging and sensitive to the low photon flux from imaging the retina
        \item By engineering changes in FAD, by restricting oxygen consumption in animal models, the changes in the fluorescence and spectra can be correlated to changes in FAD. 
        \item Rats were imaged in-vivo and oxygenation was cycled from normoxia (room air 21 percent) to hypoxia (12percent) and death (0 percent) and SFLIM imaging was carried out.
        \item Estimate of changes in FAD with oxygenation
        \begin{itemize}
            \item FAD is produced as a product of aerobic respiration.
            \item The production of FAD can be modelled by estimating the rate oxygen consumption in the retina to convert to a rate of estimated FAD production. And given the volume of blood in the retina this is extrapolated to approximate the volume and concentration of FAD. Repeating this calculation for differing oxygenations states allows for an estimate of the change in FAD we'd hope to see when transitioning from normoixa to hypoxia.
        \end{itemize}
    \end{itemize}
