...
Programmatically this is implemented through slicing the $\lambda T$ array containing the result of $\mathcal{A}\bullet_{3}\mathbf{x} - \mathbf{M}$. Mathematically this can be written as excluding of time-bins on the interval $[t_{1}, t_{2}]$:
\begin{align}
        ...
        &=\sum_{\lambda}\sum_{T}\lvert\mathbf{\psi_{\lambda t}}\rvert^{2} = \sum_{\lambda}\Bigg(\sum_{0}^{t1}\lvert\mathbf{\psi_{\lambda t}}\rvert^{2} + \sum_{t1}^{t2}\lvert\mathbf{\psi_{\lambda t}}\rvert^{2}\Bigg)
\end{align}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/ratUCL/Rat1Session1FlourophoreMaps.pdf}
    \caption{Caption}
    \label{fig:rat1session1fluormaps}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/ratUCL/Rat2Session1FlourophoreMaps.pdf}
    \caption{Caption}
    \label{fig:rat2session1fluormaps}
\end{figure}
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/ratUCL/Rat1Session2FlourophoreMaps.pdf}
    \caption{Caption}
