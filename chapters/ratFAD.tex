...
\end{figure}
Much like the integrated intensity maps in () these fluorophore maps show variation across the image that could be correlated to structures in the retina. It would be expected that there would be a background level of FAD due to blood circulating around the choroid and areas of increased FAD around the arteries. 
