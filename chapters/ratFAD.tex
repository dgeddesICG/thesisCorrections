...
Repeating this estimation process for hypoxia, \qty{15}{\percent}\ce{FiO2}, is achieved by estimating the the oxygenation saturation of blood entering the ophthalmic artery, ${S\ce{O2}}_{in} = \qty{74}{\percent}$, using measurements of pulmonary artery of subjects breathing air ranging from \qty{21}{\percent}\ce{FiO2} to \qty{12}{\percent}\ce{FiO2}. This does boldly assume that the oxygen saturation does remain constant as the blood transits the carotid artery, into the circle-of-Willis -, and then to the opthalmic artery but no measurements of ${S\ce{O2}}_{in}$ at \qty{12}{\percent}\ce{FiO2} could be found for the ophthalmic artery. The oxygen saturation of blood exiting the retina was kept consistent at ${S\ce{O2}}_{in} = \qty{55.60}{\percent}$ with the assumption that under hypoxia the body reduces oxygen delivery in the retina to sustain other essential functions e.g. the brain. These assumptions give a reduced rate of oxygen metabolisation of $Q_{\ce{O2}}=\SI{1.586}{\micro\litre\per\minute}$ (\cref{eq:O2rate})


SO2 as 74 percent \cite{soo2020use, albert2014peripheral}

\section{SFLIM Measurements of In-Vivo Rats}
\subsection{Experimental Method}Fixed 
