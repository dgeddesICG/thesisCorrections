...
\subsection{TCSPC Acquisition Modes}
...
\begin{itemize}
    ...
    \item The image is relay with a Vivitar f = 80mm lens, the SPAD is focused using a Nikon f = 50mm lens, the sCMOS is focused using a Cannon 85mm. 
