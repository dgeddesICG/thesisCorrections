...
The S-FLIO device is based upon an off-the-shelf fundus camera (Topcon TRC 50-DX) which is ordinarily capable of recording imagges of the retina with an FOV of up to \SI{50}{\degree}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Greatly simplifies the design process - much much fewer optics to optimize
...
\begin{itemize}
    ...
    \item Photon flux is too low to register imaging on a frame by frame basis with the FLIMera alone - use a standard science grade detector to record high - quality images to extract the necessary registration.
    ...
    \item The retina will be illuminated using a 78 MHz laser to match the input requirements of the FLIMera. By using a super-continuum a 
\end{itemize}
...
\begin{figure}
    \centering
    \begin{annotatedFigure}{\includegraphics[width = \textwidth]{figures/sflio-device/FLKnifeEdgeFigure.pdf}}
