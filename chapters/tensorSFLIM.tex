...
\FloatBarrier
\subsection{Tensor Definitions and Nomenclature - maybe this should be an appendix}\label{subsec:tensdef}
...
\subsection{Assessing Sensitivity to Fluorophore Concentrations}
