...
The phase cross-correlation process previously described is used to yield,$\Delta\rho, \Delta\xi$, and the original magnification, $M$, and rotation $\theta$, are then recovered using:
