...
\end{align}
"j" is the dummy index and is summed over, and element-wise multiplication is performed on the "i" and "k"  indices. 

\subsection{Einstein Products}\label{subsec:einprod}
Einstein or contracted product between two tensors can be used to contract specific indices. For example the Einstein $N$-Product over $N$ indices for two arbitrary tensors
